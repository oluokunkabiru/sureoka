										...
										<div class="fusion-column-content">
											...
											<div class="fusion-title title fusion-title-1 fusion-sep-none fusion-title-text fusion-title-size-one"
												...
												<h1 class="title-heading-left"
													style="margin:0;color:#267299;">SEO Strategy Consulting
												</h1>
											</div>
											<div class="fusion-text fusion-text-1 subheader">
												<p>The one-size-fits-all approach won’t cut it with SEO. To
													achieve the sustainable growth you want, you’ll need a
													custom strategy geared toward your specific goals. Our
													SEO consultant services provide just that.</p>
											</div>
							...
							<div class="fusion-layout-column fusion_builder_column fusion-builder-column-2 fusion_builder_column_1_1 1_1 fusion-one-full fusion-column-first fusion-column-last"
								...
								<div class="fusion-column-wrapper fusion-flex-column-wrapper-legacy"
									...
									<div class="fusion-text fusion-text-2">
										<h2 style="text-align: center;">SEO Strategy Consulting</h2>
										<p>Organic search is a huge part of business website performance, as
											well as a critical component of the buyer funnel and getting
											users to complete a conversion or engagement.</p>
										<p>We know that the average person searches Google <a
												href="https://ardorseo.com/blog/how-many-google-searches-per-day-2019/"
												target="_blank" rel="noopener noreferrer">3-4 times per
												day</a>. High visibility as a trusted resource by Google and
											other search engines is undeniably key for the success of your
											business. Strategic SEO and a high-quality website make it
											happen.</p>
										<p>At Sure Oak, we address these needs and more by providing SEO
											consultation services to determine the best marketing strategy
											for your business and how to make it successful long term.
											Through education, proper expectations, collaboration, and
											ultimately partnering with you, we ensure progress and success
											move in the right direction to improve your bottom line.</p>
									</div>
									<script type="text/javascript" async
										src="../../bot.leadoo.com/bot/inpage6b7c.js?code=uimXDgxO#seamless"></script>
									<div class="fusion-clearfix"></div>
								</div>
							</div>
						</div>
								...
								<div class="fusion-column-wrapper fusion-flex-column-wrapper-legacy"
									...
									<div class="fusion-text fusion-text-3">
										<h2 style="text-align: center;"><span
												style="color: #ffffff;">Contact us today to see how we can
												improve your visibility and your website performance!</span>
										</h2>
									</div>
