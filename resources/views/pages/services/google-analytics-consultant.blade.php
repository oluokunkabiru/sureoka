...
<main id="main" class="clearfix width-100">
	<div class="fusion-row" style="max-width:100%;">
		<section id="content" class="full-width">
			<div id="post-22610" class="post-22610 page type-page status-publish hentry"> <span
					class="entry-title rich-snippet-hidden">Services &#8211; Analytics
					Configuration</span><span class="vcard rich-snippet-hidden"><span class="fn"><a
							href="../insights/author/darrenjames13.html" title="Posts by Darren James"
							rel="author">Darren James</a></span></span><span
					class="updated rich-snippet-hidden">2021-11-14T10:56:14-05:00</span>
										...
										<div class="fusion-column-content">
											...
											<div class="fusion-title title fusion-title-1 fusion-sep-none fusion-title-text fusion-title-size-one"
												...
												<h1 class="title-heading-left"
													style="margin:0;color:#267299;">Analytics &amp; Metrics
													Tracking</h1>
											</div>
											<div class="fusion-text fusion-text-1 subheader">
												<p>No matter the scope or details of your SEO strategy,
													solid analytics and metrics are what tangibly measure
													what’s working and what’s not. Data doesn’t lie, and
													it’s a huge part of what informs our tactics here at
													Sure Oak.</p>
											</div>
									...
									<div class="fusion-column-content-centered">
										<div class="fusion-column-content">
											<div class="imageframe-align-center"><span
													...
													style="max-width:450px;"><img width="600" height="497"
														alt="Analytics &amp; Metrics Tracking"
														title="svc-strategy-consult_icon"
														src="data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20width%3D%27600%27%20height%3D%27497%27%20viewBox%3D%270%200%20600%20497%27%3E%3Crect%20width%3D%27600%27%20height%3D%27497%27%20fill-opacity%3D%220%22%2F%3E%3C%2Fsvg%3E"
														data-orig-src="https://www.sureoak.com/wp-content/uploads/2019/07/svc-strategy-consult_icon.png"
														class="lazyload img-responsive wp-image-23492" /></span>
											</div>
										</div>
									</div>
									<div class="fusion-clearfix"></div>
								...
								<div class="fusion-column-wrapper fusion-flex-column-wrapper-legacy"
									...
									<div class="fusion-title title fusion-title-2 fusion-sep-none fusion-title-center fusion-title-text fusion-title-size-two"
										...
										<h2 class="title-heading-center" style="margin:0;color:#267299;">
											Analytics &amp; Metrics Tracking</h2>
									</div>
									<div class="fusion-text fusion-text-2">
										<p>The foundation of any marketing or advertising endeavor is proper
											and accurate reporting analytics. It’s critical to identify what
											metrics are key for any strategy, and because major decisions
											will likely be made based off the data, confirming that it is
											accurate and reliable is a top priority.</p>
										<p>As part of your holistic SEO strategy, we work with you to either
											set up or update your analytic tracking methods. We then combine
											these methods with our own technologies to:</p>
										<ol class="spaced">
											<li>Provide a solid benchmark at the beginning of every strategy
												to understand where current data points lie.</li>
											<li>Set up ongoing and reliable data metrics to track throughout
												all strategies. This helps to ensure everything is moving in
												the right direction. It also allows us to see if any pivots
												to the strategy are necessary.</li>
											<li>Be able to point directly to what metrics matter the most
												for your website and business, as well as any improvements
												for ongoing success.</li>
										</ol>
										<p>We work with many types of analytic software across a variety of
											strategies, including (but not limited to):</p>
									</div>
												...
												<ul class="fusion-checklist fusion-checklist-1"
													...
													<li style="background-color:rgba(255,255,255,0);"
														...
														<div class="fusion-li-item-content"
															style="margin-left:38.4px;color:#424242;">Google
															Analytics</div>
													</li>
													<li style="background-color:rgba(255,255,255,0);"
														class="fusion-li-item"><span
								...
								<div class="fusion-column-wrapper fusion-flex-column-wrapper-legacy"
									...
									<div class="fusion-text fusion-text-3">
										<h2 style="text-align: center;"><span style="color: #ffffff;">For
												more information on the data analytics we use at Sure Oak,
												speak with a Google analytics consultant today!</span></h2>
									</div>
