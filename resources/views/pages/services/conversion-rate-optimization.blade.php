										...
										<div class="fusion-column-content">
											...
											<div class="fusion-title title fusion-title-1 fusion-sep-none fusion-title-text fusion-title-size-one"
												...
												<h1 class="title-heading-left"
													style="margin:0;color:#267299;">Conversion Rate
													Optimization Services</h1>
											</div>
											<div class="fusion-text fusion-text-1 subheader">
												<p>Want more qualified leads? Better conversion rates on
													your service pages, product pages and landing pages? Our
													conversion rate optimization services will get you
													there.</p>
											</div>
							...
							<div class="fusion-layout-column fusion_builder_column fusion-builder-column-2 fusion_builder_column_1_1 1_1 fusion-one-full fusion-column-first fusion-column-last"
								...
								<div class="fusion-column-wrapper fusion-flex-column-wrapper-legacy"
									...
									<div class="fusion-text fusion-text-2">
										...
										<p>Conversion Rate Optimization (CRO) is the process of optimizing
											your website to increase your <b>conversion rate</b>. Your
											conversion rate is the percentage of people who actually
											<i>do</i> something &#8211; like make a purchase &#8211; on your
											website, relative to the number of users who visit your site.
										</p>
										<p>But a conversion isn&#8217;t solely a sale; it can be a lead, an
											email address or a completed contact form. It varies from
											business to business and not all pages on a website have the
											same conversion goal. A service page may be aimed at getting
											visitors to reach out, whereas a product page is centered around
											getting visitors to make a purchase.</p>
										<p>At its core, CRO is about getting more from the traffic you
											already have versus generating new leads. Every business in the
											world should be focused on increasing its conversion rate.</p>
										<p>What&#8217;s the secret sauce? A fantastic User Experience (UX),
											valuable content, and well-designed sales funnels. Oh, and a
											team of marketing experts that knows how to execute a profitable
											CRO strategy.</p>
										<h3>Benefits of CRO Marketing with Sure Oak</h3>
										<p>We&#8217;ve often found that small businesses &#8211; even the
											really awesome, mission-driven ones who provide a ton of value
											&#8211; are missing the mark in regards to conversion rates. If
											your traffic is steadily increasing but you&#8217;re not getting
											more leads or sales, you should ask yourself:</p>
										<p style="text-align: center;"><b>Are you layering CTAs into your
												sales funnels?<br /> </b><b>Are you building a list of
												prospects by collecting their email address?<br />
											</b><b>Are you nurturing your leads through remarketing?</b></p>
										<p>At Sure Oak, we leave no stone unturned with CRO. Increasing
											conversion rates is part of our overall SEO growth vision for
											the businesses we work with.</p>
										<p>And the interdependent nature of SEO and CRO isn&#8217;t
											difficult to grasp:</p>
										<p><b>SEO gets you in a room with potential customers and clients.
												CRO is the key to closing.</b></p>
										<p>Our job is to go through your website and optimize your UX, your
											content and your sales funnels  so there&#8217;s a clear path
											for visitors who intend to act. Depending on your industry and
											target audience, the optimal UX for CRO can look very different.
											But the point is always the same: convert as much traffic as
											possible.</p>
										<p>By partnering with Sure Oak on your CRO needs, you&#8217;ll work
											with an expert strategist who can pinpoint every element of your
											site that needs optimizing, and who will ensure all recommended
											changes are properly executed. Let us optimize your entire site
											for conversions, so you can:</p>
									</div>
									<ul class="fusion-checklist fusion-checklist-1"
										...
										<li style="background-color:rgba(255,255,255,0);"
											...
											<div class="fusion-li-item-content"
												style="margin-left:38.4px;color:#424242;">Increase your
												revenue</div>
										</li>
										<li style="background-color:rgba(255,255,255,0);"
											class="fusion-li-item"><span
												...
												class="icon-wrapper circle-yes"><i
													...
													style="color:#2bace2;" aria-hidden="true"></i></span>
											<div class="fusion-li-item-content"
												style="margin-left:38.4px;color:#424242;">Get more qualified
												leads from traffic you already have</div>
										</li>
										<li style="background-color:rgba(255,255,255,0);"
											class="fusion-li-item"><span
												style="background-color:#bbf4ca;font-size:14.08px;height:27.2px;width:27.2px;margin-right:11.2px;"
												class="icon-wrapper circle-yes"><i
													...
													style="color:#2bace2;" aria-hidden="true"></i></span>
											<div class="fusion-li-item-content"
												style="margin-left:38.4px;color:#424242;">Decrease
												acquisition costs</div>
										</li>
										<li style="background-color:rgba(255,255,255,0);"
											class="fusion-li-item"><span
												style="background-color:#bbf4ca;font-size:14.08px;height:27.2px;width:27.2px;margin-right:11.2px;"
											...
											<div class="fusion-li-item-content"
												...
												<p>Gain more repeat customers</p>
											</div>
										</li>
										<li style="background-color:rgba(255,255,255,0);"
											class="fusion-li-item"><span
												...
												class="icon-wrapper circle-yes"><i
													...
													style="color:#2bace2;" aria-hidden="true"></i></span>
											<div class="fusion-li-item-content"
												style="margin-left:38.4px;color:#424242;">Grow your
												business!</div>
										</li>
									</ul>
									<script type="text/javascript" async
										src="../../bot.leadoo.com/bot/inpage96d9.js?code=Jk7iZeQy#seamless">
									</script>
									<div class="fusion-clearfix"></div>
								</div>
							</div>
							...
							<div class="fusion-layout-column fusion_builder_column fusion-builder-column-4 fusion_builder_column_3_5 3_5 fusion-three-fifth fusion-column-last"
								...
								<div class="fusion-column-wrapper fusion-flex-column-wrapper-legacy"
									...
									<div class="fusion-text fusion-text-3">
										<h2 style="text-align: center; color: #ffffff;">Increase your
											conversion rate. And get ready to grow!</h2>
									</div>
