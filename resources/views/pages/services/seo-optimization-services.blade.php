										...
										<div class="fusion-column-content">
											...
											<div class="fusion-title title fusion-title-1 fusion-sep-none fusion-title-text fusion-title-size-one"
												...
												<h1 class="title-heading-left"
													style="margin:0;color:#267299;">On-Page SEO Services
												</h1>
											</div>
											<div class="fusion-text fusion-text-1 subheader">
												<p>Leverage the most powerful ranking factors for your
													website with our on-page SEO optimization services.
													Check out how we cover all the bases, from keywords to
													H1 tags and more.</p>
											</div>
								...
								<div class="fusion-column-wrapper fusion-flex-column-wrapper-legacy"
									...
									<div class="fusion-title title fusion-title-2 fusion-sep-none fusion-title-center fusion-title-text fusion-title-size-two"
										...
										<h2 class="title-heading-center" style="margin:0;color:#267299;">
											What Is On-Page Optimization and Why Is It Important?</h2>
									</div>
									<div class="fusion-text fusion-text-2">
										<p>On‐page optimization is the process of optimizing website pages
											to help them rank higher and gain more visibility in the search
											engines. The end goal of this process is to increase organic
											traffic to your website and ultimately, conversions.</p>
										<p>While many individuals and businesses provide these SEO services,
											Sure Oak prides itself on focusing this process and strategy
											directly on your bottom line. This is not a service of best
											practices that have been around for 15 years. SEO changes
											yearly, monthly, sometimes even daily. We stay up-to-date on
											these trends and ensure that our clients benefit from current,
											impactful optimization strategies.</p>
									</div>
									<style type="text/css"></style>
									<div class="fusion-title title fusion-title-3 fusion-sep-none fusion-title-center fusion-title-text fusion-title-size-two"
										style="margin-top:0px;margin-right:0px;margin-bottom:31px;margin-left:0px;">
										<h2 class="title-heading-center" style="margin:0;color:#267299;">
											Sure Oak Optimization</h2>
									</div>
									<div class="fusion-text fusion-text-3">
										...
										<p>In order to accomplish a positive outcome in the above areas, we
											utilize comprehensive research and optimization development
											across the following elements. However, please note that each
											website,even each page within a website, will have its own
											unique strategy to effect maximum impact and success.</p>
									</div>
									<ul class="fusion-checklist fusion-checklist-1"
										...
										<li style="background-color:rgba(255,255,255,0);"
											class="fusion-li-item"><span
												...
												class="icon-wrapper circle-yes"><i
													...
													style="color:#2bace2;" aria-hidden="true"></i></span>
											<div class="fusion-li-item-content"
												style="margin-left:38.4px;color:#424242;">Title Tag</div>
										</li>
										<li style="background-color:rgba(255,255,255,0);"
											class="fusion-li-item"><span
												style="background-color:#bbf4ca;font-size:14.08px;height:27.2px;width:27.2px;margin-right:11.2px;"
										...
										<li style="background-color:rgba(255,255,255,0);"
											class="fusion-li-item"><span
												...
												class="icon-wrapper circle-yes"><i
													...
													style="color:#2bace2;" aria-hidden="true"></i></span>
											<div class="fusion-li-item-content"
												style="margin-left:38.4px;color:#424242;">Heading Tags
												(H1’s, H2’s, H3’s, etc.)</div>
										</li>
										<li style="background-color:rgba(255,255,255,0);"
											class="fusion-li-item"><span
												style="background-color:#bbf4ca;font-size:14.08px;height:27.2px;width:27.2px;margin-right:11.2px;"
										...
										<li style="background-color:rgba(255,255,255,0);"
											class="fusion-li-item"><span
												...
												class="icon-wrapper circle-yes"><i
													...
													style="color:#2bace2;" aria-hidden="true"></i></span>
											<div class="fusion-li-item-content"
												style="margin-left:38.4px;color:#424242;">Content Updates
												and/or New Content Creation</div>
										</li>
										<li style="background-color:rgba(255,255,255,0);"
											class="fusion-li-item"><span
												style="background-color:#bbf4ca;font-size:14.08px;height:27.2px;width:27.2px;margin-right:11.2px;"
												class="icon-wrapper circle-yes"><i
													...
													style="color:#2bace2;" aria-hidden="true"></i></span>
											<div class="fusion-li-item-content"
												style="margin-left:38.4px;color:#424242;">Strong
												Calls-to-Action</div>
										</li>
										<li style="background-color:rgba(255,255,255,0);"
											class="fusion-li-item"><span
												...
												class="icon-wrapper circle-yes"><i
													...
													style="color:#2bace2;" aria-hidden="true"></i></span>
											<div class="fusion-li-item-content"
												style="margin-left:38.4px;color:#424242;">Schema Markup
												&amp; Rich Snippets</div>
										</li>
										<li style="background-color:rgba(255,255,255,0);"
											class="fusion-li-item"><span
										...
										<li style="background-color:rgba(255,255,255,0);"
											...
											<div class="fusion-li-item-content"
												...
												Architecture &amp; UI/UX Structure</div>
										</li>
										<li style="background-color:rgba(255,255,255,0);"
											class="fusion-li-item"><span
												style="background-color:#bbf4ca;font-size:14.08px;height:27.2px;width:27.2px;margin-right:11.2px;"
										...
										<li style="background-color:rgba(255,255,255,0);"
											class="fusion-li-item"><span
												...
												class="icon-wrapper circle-yes"><i
													...
													style="color:#2bace2;" aria-hidden="true"></i></span>
											<div class="fusion-li-item-content"
												style="margin-left:38.4px;color:#424242;">And Much More!
											</div>
										</li>
									</ul>
									<script type="text/javascript" async
										src="../../bot.leadoo.com/bot/inpage1c71.js?code=OrExKUL8#seamless"></script>
									<div class="fusion-clearfix"></div>
								</div>
							</div>
						</div>
							...
							<div class="fusion-layout-column fusion_builder_column fusion-builder-column-4 fusion_builder_column_3_5 3_5 fusion-three-fifth fusion-column-last"
								...
								<div class="fusion-column-wrapper fusion-flex-column-wrapper-legacy"
									...
									<div class="fusion-text fusion-text-4">
										<h2 style="text-align: center;"><span style="color: #ffffff;">Do you
												know if your webpages are performing to their maximum
												potential? Find out more about how our SEO optimization
												services can help your business.</span></h2>
									</div>
