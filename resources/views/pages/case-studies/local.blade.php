@extends('layouts.app')
@section('title', 'Local SEO Case Studies')
								...
								<div class="fusion-column-wrapper fusion-flex-column-wrapper-legacy"
									...
									<div class="fusion-text fusion-text-1">
										<h4 style="text-align: center; color: #287399; font-weight: 400;">
											Our locally-focused SEO campaigns help businesses dominate local
											markets and attract more customers on the web. Learn the exact
											process we&#8217;ve used to grow local businesses, and imagine
											how we can impact your business, too.</h4>
									</div>
									<div class="fusion-clearfix"></div>
								</div>
							</div>
